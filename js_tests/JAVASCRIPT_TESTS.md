...
- **All HTML tools have back links** (14 tests) — Every tool in HTML Files/ has index.html link and back-link class
...
- **Back-to-home navigation** (5 tests) — Back-link element, links to index.html, arrow and text, fixed position, high z-index
- **All HTML tools have back links** (14 tests) — Every tool in HTML Files/ (including JASON) has index.html link and back-link class

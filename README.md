...
**Maps** - Political maps of dimensions. The borders drawn clean. The Substrate and Kingdom Hierarchy maps the entire cyberspace dimension — substrates, kingdoms, divisions, housing, and jurisdictions. The Physical Dimension Earth Substrate Political Map documents every continent, every nation, and every territory on Earth using the same tree hierarchy format. Same format. Same dignity. Different dimension. Two maps. Two dimensions. Both accounted for.

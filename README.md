...
**Maps** - Political maps of anything. The borders drawn clean. One tree hierarchy format that works for any dimension, any substrate, any territory. The cyberspace dimension — substrates, kingdoms, divisions, housing. The physical dimension — every continent, nation, and territory on Earth. Bikini Bottom — because the format works for a cartoon too. Same tree. Same dignity. Any dimension. The collection grows.
...
- **Maps** — Political maps of anything. One tree hierarchy format applied across dimensions: the cyberspace dimension (substrates, kingdoms, divisions, housing), the physical dimension (every continent, nation, and territory on Earth), and Bikini Bottom (proving the format works for anything — yes, including a cartoon). The collection grows. ([Full listing](Future/Maps/))

...
Blueprints and political maps using the same tree hierarchy format — dimensions, systems, languages. The format works for any substrate, any territory, any architecture. The collection grows.
